...
public class MainActivity extends AppCompatActivity {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            if checkSelfPermission( Manifest.permission.WRITE_EXTERNAL_STORAGE
             == PackageManager.PERMISSION_GRANTED) {
                ...
                AactivityCompat.requestPermisions(this, new String[] (Manifest.permission.WRITE_EXTERNAL_STORAGE),REQUEST_CODE_STORAGE );
                return false;
            }
        }else {
            return true;
    ...
    @Override
    public void onRequestPermisionsResult (int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults){
    ...
    String path =
            Environment.getExternalStorageDirectory(). toString() = "/kominfo proyek1";
    ...
    if (directory.exists()) {
        ...
        SimpleDateFormat = new
                ...
                ArrayList<Map<String, Object>> itemDateList = new
